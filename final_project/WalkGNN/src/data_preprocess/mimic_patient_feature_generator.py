...
def main():
    ...
    data_root = os.path.abspath('../../../mimic3_1.4_files')
    ...
    visit_dict = get_admissions(admission_path, save_root, read_from_cache=True)
    print('visit dict loaded')
    age_sex_dict = get_sex_age(visit_dict, save_root, patient_path, read_from_cache=True)
    ...
    operation_dict = get_procedure(visit_dict, save_root, operation_path, operation_mapping_path, read_from_cache=True)
    ...
    diagnosis_dict = get_diagnosis(visit_dict, save_root, diagnosis_path, diagnosis_mapping_path, read_from_cache=True)
