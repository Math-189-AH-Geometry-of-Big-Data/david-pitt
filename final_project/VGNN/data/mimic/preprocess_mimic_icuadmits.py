...
class EncounterInfo(object):
    def __init__(self, patient_id, encounter_id, encounter_timestamp, expired, icuTransfer):
        self.patient_id = patient_id
        self.encounter_id = encounter_id
        self.encounter_timestamp = encounter_timestamp
        self.expired = expired
        self.icu = icuTransfer
        self.dx_ids = []
        self.rx_ids = []
        self.labs = {}
        self.physicals = []
...
def tf2csr(output_path, partition, maps):
    ...
    # Note: remote  the '/' concat from the above line to restore this to normal
